...
// import SignInImg from '../Images/sign/signin.jpg'
...
//                                     <h3 className="sign__title">Welcome</h3>
...
const SignIn = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            setLoading(true);
            const res = await fetch("http://206.189.130.102:5001/api/v1/admin/admin/login", {
                method: "POST",
                            ...
                            <div className="sign__center-wrapper text-center mt-50">
                                ...
                                <div className="sign__input-form text-center">
                                    ...
                                    <form onSubmit={handleSubmit}>
                                        ...
                                        {/* Password Input */}
                                        <div className="sign__input position-relative">
                                            <input
                                                type="password"
                                                placeholder="Enter your password"
                                                value={password}
